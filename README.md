...
**Canvas YouTube 링크 카드 우클릭 → Immersive Translate 자막 가져오기**

- Chrome 작업 탭에서 자막을 준비합니다. 필요한 경우 AI 자막을 한 번 요청합니다. 공급자의 확인 창·요금제 제한은 자동 승인하지 않습니다.
...
- 자동 테스트 16개와 빌드 통과. Sandbox 설정 저장·재시작 유지 확인.
